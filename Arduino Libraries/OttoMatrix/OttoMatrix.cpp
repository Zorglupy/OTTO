...
void OttoMatrix::init(int YL, int YR, int RL, int RR, bool load_calibration, int NoiseSensor, int Buzzer, int USTrigger, int USEcho) {
...
//-- OSCILLATORS TRIMS ------------------------------------------//
///////////////////////////////////////////////////////////////////
void OttoMatrix::setTrims(int YL, int YR, int RL, int RR) {
  servo[0].SetTrim(YL);
  servo[1].SetTrim(YR);
  servo[2].SetTrim(RL);
  servo[3].SetTrim(RR);
...
void OttoMatrix::saveTrimsOnEEPROM() {
...
///////////////////////////////////////////////////////////////////
void OttoMatrix::_moveServos(int time, int  servo_target[]) {
...
void OttoMatrix::oscillateServos(int A[4], int O[4], int T, double phase_diff[4], float cycle=1){
...
void OttoMatrix::_execute(int A[4], int O[4], int T, double phase_diff[4], float steps = 1.0){
...
bool OttoMatrix::getRestState(){

    return isOttoResting;
}

void OttoMatrix::setRestState(bool state){
...
//--    T: Period
//---------------------------------------------------------
void OttoMatrix::jump(float steps, int T){
...
//---------------------------------------------------------
void OttoMatrix::walk(float steps, int T, int dir){
...
//---------------------------------------------------------
void OttoMatrix::turn(float steps, int T, int dir){

  //-- Same coordination than for walking (see OttoMatrix::walk)
...
//---------------------------------------------------------
void OttoMatrix::bend (int steps, int T, int dir){
...
//---------------------------------------------------------
void OttoMatrix::shakeLeg (int steps,int T,int dir){
...
//---------------------------------------------------------
void OttoMatrix::updown(float steps, int T, int h){
...
//---------------------------------------------------------
//-- OttoMatrix movement: swinging side to side
//--  Parameters:
//--     steps: Number of steps
//--     T : Period
//--     h : Amount of swing (from 0 to 50 aprox)
//---------------------------------------------------------
void OttoMatrix::swing(float steps, int T, int h){
...
//--     h : Amount of swing (from 0 to 50 aprox)
//---------------------------------------------------------
void OttoMatrix::tiptoeSwing(float steps, int T, int h){
...
//---------------------------------------------------------
void OttoMatrix::jitter(float steps, int T, int h){
...
//---------------------------------------------------------
void OttoMatrix::ascendingTurn(float steps, int T, int h){
...
//--    dir: Direction: LEFT / RIGHT
//---------------------------------------------------------
void OttoMatrix::moonwalker(float steps, int T, int h, int dir){
...
//--     dir:  Direction: LEFT / RIGHT
//-----------------------------------------------------------
void OttoMatrix::crusaito(float steps, int T, int h, int dir){
...
//---------------------------------------------------------
void OttoMatrix::flapping(float steps, int T, int h, int dir){
...
//---------------------------------------------------------
double OttoMatrix::getBatteryLevel(){
...
double OttoMatrix::getBatteryVoltage(){
...
unsigned long int OttoMatrix::getMouthShape(int number){
...
unsigned long int OttoMatrix::getAnimShape(int anim, int index){
...
void OttoMatrix::putAnimationMouth(unsigned long int aniMouth, int index){

      ledmatrix.writeFull(getAnimShape(aniMouth,index));
}


void OttoMatrix::putMouth(unsigned long int mouth, bool predefined){
...
void OttoMatrix::_tone (float noteFrequency, long noteDuration, int silentDuration){
    ...
    // delay(500);
      ...
      tone(OttoMatrix::pinBuzzer, noteFrequency, noteDuration);
...
void OttoMatrix::bendTones (float initFrequency, float finalFrequency, float prop, long noteDuration, int silentDuration){
...
void OttoMatrix::sing(int songName){
  switch(songName){
...
void OttoMatrix::playGesture(int gesture){
